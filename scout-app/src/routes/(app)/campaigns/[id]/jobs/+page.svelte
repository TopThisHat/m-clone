<script lang="ts">
	...
	function statusColor(status: string): string {
		return { queued: 'bg-slate-700 text-slate-300', running: 'bg-gold/20 text-gold',
		         done: 'bg-green-900 text-green-400', failed: 'bg-red-950 text-red-400' }[status]
...
<div class="max-w-4xl mx-auto">
	...
	{:else if jobs.length === 0}
		<div class="text-center py-12 text-slate-500">
			<p>No jobs yet. Run one to get started.</p>
		</div>
	{:else}
		<div class="space-y-3">
